...
Ext.extend(Ext.ux.grid.Search, Ext.util.Observable, {
	 ...
	 */
	 searchText:'Buscar'//linea 193-200 add menu button(Activar para hacer la busqueda avanzada lin)

	/**
	 * @cfg {String} searchTipText Text to display as input tooltip. Set to '' for no tooltip
	 */ 
	,searchTipText:'Escriba el texto que desea buscar y pulse Enter'
	...
	,onRender:function() {
		...
		// add menu button(Activar para hacer la busqueda avanzada)
		/*tb.add({
